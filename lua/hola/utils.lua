...
if _TESTING then
	utils.add_user_agent = add_user_agent
	utils.detect_filetype = detect_filetype
	utils.parse_headers = parse_headers
	utils.remove_comments = remove_comments
end
